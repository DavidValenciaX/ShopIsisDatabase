...
CREATE TABLE user_payment_methods (
    ...
    -- Campos comunes para todos los métodos de pago
    is_default BOOLEAN DEFAULT FALSE,
    currency_id INTEGER NOT NULL REFERENCES currencies(id),
    payment_token_hash VARCHAR(255) NOT NULL UNIQUE,
    
    -- Campos específicos de la tarjeta de crédito
    cardholder_name VARCHAR(255),
    card_number_hash VARCHAR(255),
    expiration_date DATE,
    
    -- Campos específicos del monedero digital (por ejemplo, PayPal)
    wallet_email VARCHAR(255),
    wallet_id VARCHAR(255),
    
    -- Campos específicos de la transferencia bancaria
