...
CREATE TABLE user_payment_methods (
    ...
    payment_token_hash VARCHAR(255) NOT NULL,
...
CREATE TABLE discounts (
    ...
    name VARCHAR(100) NOT NULL,
    description VARCHAR(255),
    discount_type_id INTEGER NOT NULL REFERENCES discount_types(id) ON DELETE RESTRICT,
...
CREATE TABLE orders (
    ...
    shipping_address_id INTEGER REFERENCES addresses(id) ON DELETE RESTRICT,
...
CREATE TABLE order_taxes (
    ...
    applicable_percentage DECIMAL(4, 2) NOT NULL, -- Guardar el % aplicado en ese momento
...
CREATE TABLE order_discounts (
    ...
    original_value DECIMAL(10, 2) NOT NULL, -- Valor del descuento al aplicarse
...
-- Tabla de Inventario (modificada)
...
CREATE TABLE sales_return_items (
    ...
    product_order_id INTEGER NOT NULL REFERENCES product_orders(id) ON DELETE RESTRICT,
    quantity INTEGER NOT NULL CHECK (quantity > 0),
    reason VARCHAR(255),
